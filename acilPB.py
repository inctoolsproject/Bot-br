...
if (six.PY2):
    ...
    import urllib.parse
acil = PRANKBOTS.LINE()
acil.login(token="EsFy3B9Uc0sN0Op4UnPe.4uWnRTJU51yT+/CjXTyHBG.YiaxIqSoSV2x0LQrqNPwXQB+f8m+ljfHofT4yQvJrWc=
")
acil.loginResult()
ki = PRANKBOTS.LINE()
...
ki.loginResult()
ki2= PRANKBOTS.LINE()
ki2.login(token="Esb2BkWPDY2j0kHYvhG8.1e8nOeP/17yuiWiheXA//a.mcG/x3V1L+74JDW06/7i9+jABWgG3FkMDlSv/dKogPM=")
ki2.loginResult()
ki3 = PRANKBOTS.LINE()
ki3.login(token="ErNWKGHGwXaLki7ML72f.StMJ2yMSv7H5XrT17lGnZW.TGLf4X1ECQipB7QP/WjsvCO/9bDhPyvnUgbmc2GN188=")
ki3.loginResult()
ki4 = PRANKBOTS.LINE()
ki4.login(token="EsrfQZ8UuhC0iP3bVR53.Z7tUqKO5oaEP2cnIzYreyW.rbutBuMKyDEsQ2+GOoxkFadFG2sj8D575isv21/327A=
")
ki4.loginResult()
ki5 = PRANKBOTS.LINE()
ki5.login(token="EsJ3WcA4hz7TXAigNa71.hSPlQK0sOlldo8W2iFcJWq.OzOnppre6kbfYStiSOyaMoPDzLqxhD6QVBwU+vSf8mA=")
print "login success"
reload(sys)
